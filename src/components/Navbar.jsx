...
import Logo from "../assets/logo/Lilac-Spa.jpg";
    ...
    <>
      <header className={`zn-navbar ${scrolled ? "zn-navbar-scrolled" : ""}`}>
        <div className="zn-container">
          <a href="#home" className="zn-logo" onClick={closeMenu}>
            <img src={Logo} alt={BUSINESS.name} className="zn-logo-img" />
          ...
          <button className="zn-menu-btn" onClick={() => setOpen(!open)} aria-label={open ? "Close menu" : "Open menu"}>
