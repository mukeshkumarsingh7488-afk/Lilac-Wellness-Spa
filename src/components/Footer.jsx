          ...
          <div className="zn-footer-grid">
            <div className="zn-footer-brand">
              <div className="zn-footer-head">
                <img src={Logo} alt={BUSINESS.name} className="zn-footer-logo" />
                <div>
                  <h3>{BUSINESS.name}</h3>
